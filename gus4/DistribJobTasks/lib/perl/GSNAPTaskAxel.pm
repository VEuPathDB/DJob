...
# things which need to happen on the server
# one time (before nodes are requested
sub initServer {
    my ($self, $inputDir) = @_;
...
sub cleanUpServer {
    ...
    return if $self->getProperty('postProcess') ne "yes";
